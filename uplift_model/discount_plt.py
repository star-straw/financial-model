...
from main import  df_model_discount
...
ax.text(5.5, 0.65, 'Mean Values - Discount Treatment', fontsize=6, ha='left', va='top', weight='bold')
ax.text(5.5, 0.60, 'Each feature get value of 0 (No) and 1 (yes) => Mean is the % of Yes', fontsize=4, ha='left', va='top')
